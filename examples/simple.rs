...
fn rev(){
    ...
    let ret = adjoints.get_mut(&l0).expect("l0 adjoint missing").apply_rev();
...
fn rev_over_rev(){
    ...
    let mut l0_adj_2 = l0_adj.rev().get_mut(&l0).expect("l0 adjoint missing").clone();
...
fn rev_over_rev_2(){
    ...
    let mut ret = a.rev().get_mut(&l0).expect("l0 adjoint missing")
        .rev().get_mut(&l0).expect("l0 adjoint missing").apply_rev();
...
fn fwd_over_rev(){
    ...
    let ret = a.rev().get(&l0).expect("l0 adjoint missing").fwd().apply_fwd();
...
fn rev_over_fwd(){
    ...
    let ret = a.fwd().rev().get_mut(&l0).expect("l0 adjoint missing").apply_rev();
...
fn rev_rev_2nd_partial(){
    ...
    let mut l0 = dg::Leaf( dg::ValType::F(4.) );
    let mut l1 = dg::Leaf( dg::ValType::F(3.) );
    let mut a = dg::Mul( dg::Mul( l0.clone(), l0.clone()), dg::Mul( l1.clone(), l1.clone()) );
